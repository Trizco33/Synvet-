...
import ConfiguracoesImportar from "@/pages/configuracoes-importar";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/app/configuracoes/importar">{() => <ProtectedRoute component={ConfiguracoesImportar} />}</Route>
